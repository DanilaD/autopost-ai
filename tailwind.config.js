    ...
    theme: {
        extend: {
            colors: {
                ...
                // Material Design 3 Prefixed Colors (for components)
                'md-primary': '#2196f3',
                ...
                'md-surface-container': '#f3f0f4',
                'md-on-surface-container': '#1c1b1f',
                ...
                'md-warning-container': '#ffecb3',
                'md-on-warning-container': '#ff6f00',
