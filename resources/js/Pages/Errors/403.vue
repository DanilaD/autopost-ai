    ...
    >
        ...
        >
            ...
            <div class="space-y-4">
                ...
                <Link
                    :href="route('login')"
                    class="w-full py-3 px-4 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all duration-200 rounded-md inline-block"
                >
                    {{ t('auth.login') }}
                </Link>
            </div>
